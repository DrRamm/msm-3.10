...
static struct clk_lookup msm_camera_clocks_8974pro_only[] = {
	...
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "34.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "5a.qcom,camera"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "a0.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_src_clk", mclk0_clk_src, "5a.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_src_clk", mclk2_clk_src, "6c.qcom,camera"),
	CLK_LOOKUP_OF("cam2_src_clk", mclk2_clk_src, "20.qcom,camera"),
	...
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "34.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "5a.qcom,camera"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "a0.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk0_clk, "5a.qcom,eeprom"),
	CLK_LOOKUP_OF("cam_clk", camss_mclk2_clk, "6c.qcom,camera"),
	CLK_LOOKUP_OF("cam2_clk", camss_mclk2_clk, "20.qcom,camera"),
